...
public enum Logger {
    ...
    public static let app       = ModuleLog(name: "APP")
    public static let download  = ModuleLog(name: "DOWNLOAD")
    public static let recording = ModuleLog(name: "RECORDING")
    public static let asr       = ModuleLog(name: "ASR")
    public static let pipeline  = ModuleLog(name: "PIPELINE")
    public static let scheduler = ModuleLog(name: "SCHEDULER")
    public static let storage   = ModuleLog(name: "STORAGE")
    public static let cache     = ModuleLog(name: "CACHE")
...
// MARK: - 便捷方法
public extension Logger.ModuleLog {
