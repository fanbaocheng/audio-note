...
public final class AudioProcessingEngine {
    ...
    public func extractAudio(from videoURL: URL, outputDir: URL? = nil) async throws -> URL {
    ...
    /// 重采样音频文件
    public func resample(input: URL, sampleRate: Int = 16000, channels: Int = 1, outputDir: URL? = nil) async throws -> URL {
    ...
    /// 获取音频时长（秒）
    public func getDuration(_ audioURL: URL) async -> TimeInterval? {
