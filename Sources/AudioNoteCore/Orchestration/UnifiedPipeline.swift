...
/// Stage 4: 结果输出
@MainActor
public final class UnifiedPipeline: ObservableObject {
    public static let shared = UnifiedPipeline()
    private init() {}

    /// 处理 URL 下载 → 自动转写
    public func processDownload(task: UniTask, outputDir: URL? = nil) async {
    ...
    public func processRecording(task: UniTask, fileURL: URL, outputDir: URL? = nil) async {
    ...
    public func processFileImport(task: UniTask, fileURL: URL, outputDir: URL? = nil) async {
