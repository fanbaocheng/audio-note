...
public final class DependencyManager: ObservableObject {
    ...
    @Published public var checkResults: [DependencyCheck] = []
    @Published public var allReady: Bool = false

    // MARK: - 依赖项定义

    public struct DependencyCheck: Identifiable {
        public let id: String
        public let name: String
        public let description: String
        public let level: CheckLevel
        public var status: CheckStatus = .pending
        public var detail: String = ""

        public enum CheckLevel: String {
    ...
    public func buildChecklist() -> [DependencyCheck] {
        return [
    ...
    public func runAllChecks() async {
        isChecking = true
    ...
    public func installPythonDependencies() async throws {
    ...
    /// 下载 sherpa-onnx 模型文件
    public func downloadModel(progress: @escaping (Double) -> Void) async throws {
    ...
    public func modelDirectory() -> URL {
    ...
    public enum DepError: LocalizedError {
